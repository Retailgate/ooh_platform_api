...
export const TrainAssetsController = {
  ...
  async getExternalAssetSpecs(req: Request, res: Response): Promise<void> {
    try {
      const query = `SELECT a.id, c.asset_id, c.asset_name AS "asset_type",a.asset_name AS "viaduct_name", a.asset_direction, a.latitude, a.longitude,
